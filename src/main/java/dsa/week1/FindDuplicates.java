	...
	*/
	...
	// 
		...
		public void example1(){
			...
			Assert.assertEquals(true,Arrays.equals(squareAndSort(numbers),new int[] {0,1,9,16,100}));
		}

		@Test //Edge
		public void example2(){
			int[] numbers = {3,3,3,5,7};
			Assert.assertEquals(true,Arrays.equals(squareAndSort(numbers),new int[] {9,9,9,25,49}));
		}
		
		@Test //Negative
		public void example3(){
			int[] numbers = {};
			Assert.assertEquals(true,Arrays.equals(squareAndSort(numbers),new int[] {}));
		}
